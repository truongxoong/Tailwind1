...
function addProductCart() {
  let cartProductList = document.querySelector('.cartProduct')
    ...
    cartProduct.innerHTML = '<div class="grid grid-cols-2 gap-2 py-5 border-b">    <div class=" w-[110px] h-[130px]  m-auto"> <img class=" w-full h-full object-cover " src="../img/women4.png" alt=""></div><div class="flex justify-between flex-col"><div><h4 class="">Váy chấm bi</h4><p class="text-sm text-gray-500">$20</p></div><div><input class="w-[50px] border-0 focus:outline-none pl-1" type="number" value="1" min="1"></div><div><i class="fa-solid fa-pen-to-square"></i><i class="fa-solid fa-trash-can pl-[10px]"></i></div></div></div>'
